...
urlpatterns = [
    ...
    path("recipes/<slug:slug>/convert/", views.recipe_convert, name="recipe_convert"),
    ...
    path("substitutions/lookup/", views.substitution_lookup, name="substitution_lookup"),
    path("substitutions/<int:pk>/delete/", views.substitution_delete, name="substitution_delete"),
